...
internal class MenuAvaliarAlbum : Menu
{
    public override void Executar(Dictionary<string, Banda> bandasRegistradas)
    {
        ...
        if (bandasRegistradas.TryGetValue(nomeDaBanda, out Banda? banda))
        {
            ...
            if (banda.Albuns.Any(a => a.Nome.Equals(tituloAlbum, StringComparison.OrdinalIgnoreCase)))
            {
                Album album = banda.Albuns.First(a => a.Nome.Equals(tituloAlbum, StringComparison.OrdinalIgnoreCase));
